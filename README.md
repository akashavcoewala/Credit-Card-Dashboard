...
Project Workflow
Loaded credit card and customer data into a PostgreSQL database.
Connected the database to Power BI.
Performed data transformation and cleaning in Power BI.
Created calculated fields and measures using DAX.
Built a clean, interactive dashboard to visualize key trends and metrics.
Key Insights (Sample)
